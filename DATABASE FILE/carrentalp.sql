...
--
-- Host: 127.0.0.1
-- Generation Time: May 27, 2025 at 10:03 PM
...
(16, 'toyota corola 2025', '1ewr3g', 'assets/img/cars/img11.avif', 10, 5, 10, 5, 'yes');
...
('ali_nd', 'ali nd', '03123456', 'ali@mail.com', 'beirut', 'password');
...
('housam_taleb', 'housam taleb', '1234678', 'housam@mail.com', 'beirut', 'password');
...
(9, 'ali zaraat', '123164679', '7112346', 'beirut', 'male', 'ali_nd', 'yes');
...
(574681264, 'housam_taleb', 16, 9, '2025-05-27', '2025-05-28', '2025-05-31', '2025-05-27', 0, 'km', 50, 3, 0, 'R');
...
--
ALTER TABLE `rentedcars`
  MODIFY `id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=574681265;
